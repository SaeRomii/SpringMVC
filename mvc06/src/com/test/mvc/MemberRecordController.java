...
public class MemberRecordController
{
	...
	*/
	...
	// 특정한 메소드에 리스트와 관련된 요청인지 인서트와 관련된 요청인지 등 분류
	...
	public String memberInsert(MemberDTO dto) throws ClassNotFoundException, SQLException	// request객체(id,name 등)는 MemberDTO dto로 넘어온거임
	{	
		String result = "";
