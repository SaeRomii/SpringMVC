...
<script type="text/javascript">	// datepicker 사용할거임
	...
	$(function()
	{
		...
		$("#submitBtn").click(function()
		{
			...
			// 최소 기본급에 대한 유효성 검사
			// minBasicPay가 basicPay보다 크면 submit하면 안됨
			
			//alert($("#minBasicPay").val());	//-- 값 안나옴
			//alert($("#minBasicPay").text());	//-- 값 나옴 사원으로 하면 1,000,000
			
			if( parseInt($("#minBasicPay").text()) > parseInt($("#basicPay").val()) )
			{
				$("#err").html("입력하신 기본급이 최소 기본급보다 금액이 적습니다.")
				$("#err").css("display", "inline");
				return;		//-- submit 액션 처리 중단~!!!
			}
				...
				<tr>
					...
					<td>
						<select id="regionId" name="regionId">
							<!-- 
							<option value="1">서울</option>	1= 지역이 가지고 있는 아이디 / 서울 = 지역이 가지고 있는 이름
