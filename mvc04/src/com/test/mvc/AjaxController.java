...
public class AjaxController implements Controller		// get방식이든 post방식이든 Controller가 다 받음
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		// 데이터 수신 (→ EmployeeInsertForm.jsp(VIEW)로 부터 positionId 수신)
		/* EmployeeInsertForm에서 데이터 수신 받고 보내주는 부분
